...
const noButtonStages = ["No", "Are you sure?", "Please", "Pretty please", "Koko Please 🥺"];
const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return <div className="min-h-screen valentine-gradient flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      {/* Main headline */}
      <h1 className="font-display text-3xl sm:text-4xl text-center text-foreground mb-2 animate-fade-in-up" style={{
      animationDelay: '0.1s'
    }}>
        Will you be my
      </h1>
      <h2 className="font-display text-3xl sm:text-4xl text-center mb-1 animate-fade-in-up" style={{
      animationDelay: '0.15s'
    }}>
        valentine <span className="text-primary">koko baby</span>?
      </h2>
      ...
      {/* Subtitle */}
      <p className="text-muted-foreground text-base mb-12 animate-fade-in-up" style={{
      animationDelay: '0.2s'
    }}>
      ...
      {/* Action buttons */}
      <div className="flex flex-col gap-4 w-full max-w-sm animate-fade-in-up" style={{
      animationDelay: '0.3s'
    }}>
        {/* Yes button - goes straight to page 2 */}
        <Button variant="valentine" size="xl" onClick={handleYesClick} className="w-full rounded-full text-lg">
          Yes, I'd love to!
        </Button>
        ...
        <Button variant="valentineOutline" size="xl" onClick={handleNoClick} className={`w-full rounded-full text-lg ${noStage > 0 ? 'border-primary/60' : ''}`}>
      ...
      <div className="absolute left-[10%] top-[45%]">
        <Heart size={18} className="text-primary/30 fill-primary/20 animate-gentle-float" style={{
        animationDelay: '0.5s'
      }} />
      </div>
